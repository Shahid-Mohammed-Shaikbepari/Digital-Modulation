function [BER,SER,EVM,Packet_loss] = QAM64(Eb_No, N_Packets, packet_size)
%% Tranmitter side:
...
plot(1:length(Tx_vec1), Tx_vec1); 
title('Tx waveform');
xlabel('length of Txvec');
ylabel('Tx vector');%plot the signal which will be transmitted.
